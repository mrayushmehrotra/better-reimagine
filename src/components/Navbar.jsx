  ...
  return (
    ...
    >
      <FlexWorker id="div-part1">
        ...
        <Link href={"/about-us"}>
          <NavItem id="nav-items">About Us</NavItem>
        </Link>
        <Link href={"/mortgage-calc"}>
          <NavItem id="nav-items">Mortgage Calculator</NavItem>
        </Link>
        <NavItem id="nav-items">Start</NavItem>
